                        ...
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input id="center_id" type="hidden" class="form-control" name="center_id" value="{{ old('center_id') }}" required autofocus>
                            ...
                            <div class="form-group{{ $errors->has('type') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <select id="admin" class="form-control" name="Admin" value="{{ old('admin') }}" required autofocus>
